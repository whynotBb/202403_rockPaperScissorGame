        ...
        return (
            <div className="body_wrapper">
                <div className="box_wrap">
                    <BoxClass
                        type="user"
                        selected={this.state.userSelect}
                        result={this.state.result}
                    />
                    <BoxClass
                        type="com"
                        selected={this.state.comSelect}
                        result={this.state.result}
                    />
                </div>
                ...
                <div className="btn_wrap">
                    <button onClick={() => this.userSelectHandler(0)}>
                        ✊
                    </button>
                    <button onClick={() => this.userSelectHandler(1)}>
                        ✋
                    </button>
                    <button onClick={() => this.userSelectHandler(2)}>
                        ✌
                    </button>
                </div>
